function [sp,LP] = estimateMaxdVdtNthreshold(LP,sp,k,params,cellID,folder)
%{
...
for i = 1:length(LP.putSpTimes2)                                            % for each putative spike
    ...
    vec = dVdt(sp.peakTime(i) - (params.maxDiffThreshold2PeakT / ...
        LP.acquireRes) : maxdVdtTime(i));                                   % dV/dt vector
...
diffthreshold2peakT = (sp.peakTime-thresholdTime)*LP.acquireRes;
