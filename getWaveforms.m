...
params.windowBeg = round(1.2/LP.acquireRes);              % time prior to spike
params.windowEnd = round(5/LP.acquireRes);              % time after spike
params.windowBegS = round(1/params.sampleRTdt);         % time prior to spike
params.windowEndS = round(4/params.sampleRTdt);         % time after spike
